...
def modificar_datos():
    ...
    # Mostrar la tabla para que el usuario pueda ver el ID
    ver_tabla()
...
def main():
    ...
    while True:
        ...
        console.print("3. [bold yellow]Modificar[/bold yellow] registro") # <-- NUEVA OPCIÓN
        console.print("4. [bold magenta]Exportar[/bold magenta] a Excel (.xlsx)")
        console.print("5. [bold red]Salir[/bold red]") # <-- OPCIÓN SALIR ES AHORA 5
        
        # Actualizamos las choices a 1, 2, 3, 4, 5
        ...
        if opcion == "1":
            ...
            ver_tabla()
            Prompt.ask("\nPresione Enter para continuar...")
        elif opcion == "3": # <-- LÓGICA DE MODIFICACIÓN
            modificar_datos()
            Prompt.ask("\nPresione Enter para continuar...")
        elif opcion == "4":
            exportar_datos()
